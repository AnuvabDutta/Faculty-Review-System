...
public class view_post_feedback extends javax.swing.JFrame {

    public view_post_feedback() {
        initComponents();
    }
...
this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Logger.getLogger(view_post_feedback.class.getName()).log(Level.SEVERE, null, ex);
        }
this.dispose();
